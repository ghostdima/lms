                                            ...
                                            <div class="controls">
                                                <select name = "Section" tabindex="1" value="SC" data-placeholder="" class="span8" required>
                                                  ...
                                                  <option value=""></option>
                                                    ...
                                                    <option value=" Historical Fiction" <?php echo($row['Section']==" Historical Fiction")? 'selected':''; ?>> Historical Fiction</option>

                                                    <option class="Literary" <?php echo($row['Section']=="Literary")? 'selected':''; ?>>Literary</option>

                                                    <option value="Reserved Books"<?php echo($row['Section']==" Books")? 'selected':''; ?>> Reserved Books</option>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy;   </b> Mafia 2024 All rights reserved.
            </div>
        </div>
